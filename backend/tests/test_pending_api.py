...
def test_pending_endpoint_returns_rows_sorted_desc(migrated_engine, auth_client):
    ...
    auth_client.app.dependency_overrides[get_session] = override_get_session
    ...
    try:
        resp = auth_client.get("/api/whales/pending")
...
def test_pending_endpoint_empty_returns_empty_list(migrated_engine, auth_client):
    Session = sessionmaker(bind=migrated_engine, expire_on_commit=False)
